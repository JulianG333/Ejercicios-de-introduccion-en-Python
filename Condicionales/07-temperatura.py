print("CONVERSION DE UNIDADES DE TEMPERATURA")
...
if opcion == 1:
    ...
    F = float(input("Ingresa la temperatura en Fahrenheit: "))
    Ra = F + 459.67
    print("La temperatura en Rankine es ", Ra)
elif opcion == 4:
    F = float(input("Ingresa la temperatura en Fahrenheit: "))
    Re = (F - 32) / 2.25
    print("La temperatura en Réaumur es ", Re)
elif opcion == 5:
    ...
    Ra = float(input("Ingresa la temperatura en Rankine: "))
    C = (Ra - 32 - 459.67) / 1.8
    print("La temperatura en Celsius es ", C)
elif opcion == 14:
    Ra = float(input("Ingresa la temperatura en Rankine: "))
    ...
    Re = float(input("Ingresa la temperatura en Réaumur: "))
    C = Re * 1.25
    print("La temperatura en Celsius es ", C)
elif opcion == 18:
    Re = float(input("Ingresa la temperatura en Réaumur: "))
